    ...
    <main className='main flex' >
      <div className="flex left-section" >
        <button onClick={()=> {
          ...
          setArry([
            {projectTitle: "react project",category :"towColors",projectP:"موقع بلونين",imgPath:"/public/images/towColors.png"},
              ...
              // بقية المشاريع
                    ...
                    {projectTitle: "css project",category :"css",projectP:"This Is Porject Build By CSS",imgPath:"/public/images/lightColor.png",link: "https://majidahcode.github.io/photograghic-website/"},
                    {projectTitle: "node & express project",category :"node & express",projectP:"This Is Porject Build By Node & Express",imgPath:"/images/image10.jpg", link: "https://sensational-starburst-b82f23.netlify.app/" // الرابط الذي تريد فتحه
                    },
                    {projectTitle: "javascript project",category :"javaScript",projectP:"This Is Porject Build By JavaScript",imgPath:"/images/image1.jpg"},
                    {projectTitle: "bootstrap project",category :"dark",projectP:"متغير اللون داكن وفاتح",imgPath:"/images/darkLight.png",link: "https://majidahcode.github.io/Personal-Website-with-Dark-Light-Mode/" }
